...
self.addEventListener('fetch', e => {
  ...
  if (isHTML) {
    // NETWORK-FIRST for pages: always try to load the freshest HTML so code
    // fixes appear on the next load. Fall back to cache only when offline.
    e.respondWith(
